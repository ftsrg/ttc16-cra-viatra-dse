...
/**
 * Pattern-specific match representation of the hu.bme.mit.viatra.ttc.dse.queries.classModel pattern,
 * to be used in conjunction with {@link ClassModelMatcher}.
 * 
...
public abstract class ClassModelMatch extends BasePatternMatch {
  private ClassModel fCm;
  
  private static List<String> parameterNames = makeImmutableList("cm");
  
  private ClassModelMatch(final ClassModel pCm) {
    this.fCm = pCm;
  }
  ...
  public List<String> parameterNames() {
    return ClassModelMatch.parameterNames;
  }
  ...
  @Override
  public ClassModelMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ClassModelMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ClassModelMatch other = (ClassModelMatch) obj;
  ...
  @Override
  public ClassModelQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ClassModelMatch newEmptyMatch() {
   ...
   * 
   */
  public static ClassModelMatch newMutableMatch(final ClassModel pCm) {
   ...
   * 
   */
  public static ClassModelMatch newMatch(final ClassModel pCm) {
    return new Immutable(pCm);
  }
  
  private static final class Mutable extends ClassModelMatch {
  ...
  private static final class Immutable extends ClassModelMatch {
