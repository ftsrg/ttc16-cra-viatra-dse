...
/**
 * Pattern-specific match representation of the hu.bme.mit.viatra.ttc.dse.queries.encapsulated pattern,
 * to be used in conjunction with {@link EncapsulatedMatcher}.
 * 
...
public abstract class EncapsulatedMatch extends BasePatternMatch {
  ...
  private EncapsulatedMatch(final architectureCRA.Class pC, final Feature pF) {
    this.fC = pC;
    this.fF = pF;
  }
  ...
  public List<String> parameterNames() {
    return EncapsulatedMatch.parameterNames;
  }
  ...
  @Override
  public EncapsulatedMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof EncapsulatedMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    EncapsulatedMatch other = (EncapsulatedMatch) obj;
  ...
  @Override
  public EncapsulatedQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EncapsulatedMatch newEmptyMatch() {
   ...
   * 
   */
  public static EncapsulatedMatch newMutableMatch(final architectureCRA.Class pC, final Feature pF) {
   ...
   * 
   */
  public static EncapsulatedMatch newMatch(final architectureCRA.Class pC, final Feature pF) {
    return new Immutable(pC, pF);
  }
  
  private static final class Mutable extends EncapsulatedMatch {
  ...
  private static final class Immutable extends EncapsulatedMatch {
