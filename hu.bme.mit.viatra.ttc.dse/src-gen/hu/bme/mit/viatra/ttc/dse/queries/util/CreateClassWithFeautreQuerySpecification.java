...
/**
 * A pattern-specific query specification that can instantiate CreateClassWithFeautreMatcher in a type-safe way.
 * 
...
public final class CreateClassWithFeautreQuerySpecification extends BaseGeneratedEMFQuerySpecification<CreateClassWithFeautreMatcher> {
  private CreateClassWithFeautreQuerySpecification() {
   ...
   * 
   */
  public static CreateClassWithFeautreQuerySpecification instance() throws ViatraQueryException {
    try{
  ...
  @Override
  public CreateClassWithFeautreMatch newEmptyMatch() {
    return CreateClassWithFeautreMatch.newEmptyMatch();
  }
  
  @Override
  public CreateClassWithFeautreMatch newMatch(final Object... parameters) {
    return CreateClassWithFeautreMatch.newMatch((architectureCRA.ClassModel) parameters[0], (architectureCRA.Feature) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CreateClassWithFeautreQuerySpecification} to be created 
   * 	<b>not</b> at the class load time of the outer class, 
   * 	but rather at the first call to {@link CreateClassWithFeautreQuerySpecification#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private final static CreateClassWithFeautreQuerySpecification INSTANCE = new CreateClassWithFeautreQuerySpecification();
