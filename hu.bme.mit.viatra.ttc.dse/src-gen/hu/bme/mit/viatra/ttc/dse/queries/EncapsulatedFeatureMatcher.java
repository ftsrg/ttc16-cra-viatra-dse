...
public class EncapsulatedFeatureMatcher extends BaseMatcher<EncapsulatedFeatureMatch> {
  ...
  public static EncapsulatedFeatureMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = (EncapsulatedFeatureMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static EncapsulatedFeatureMatcher create() throws ViatraQueryException {
    return new EncapsulatedFeatureMatcher();
  }
   ...
   * 
   */
  private EncapsulatedFeatureMatcher() throws ViatraQueryException {
