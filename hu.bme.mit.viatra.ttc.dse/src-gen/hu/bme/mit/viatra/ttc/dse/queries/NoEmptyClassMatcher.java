...
public class NoEmptyClassMatcher extends BaseMatcher<NoEmptyClassMatch> {
  ...
  public static NoEmptyClassMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = (NoEmptyClassMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static NoEmptyClassMatcher create() throws ViatraQueryException {
    return new NoEmptyClassMatcher();
  }
   ...
   * 
   */
  private NoEmptyClassMatcher() throws ViatraQueryException {
