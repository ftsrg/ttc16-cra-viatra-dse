...
public class MergeClassesMatcher extends BaseMatcher<MergeClassesMatch> {
  ...
  public static MergeClassesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = (MergeClassesMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static MergeClassesMatcher create() throws ViatraQueryException {
    return new MergeClassesMatcher();
  }
   ...
   * 
   */
  private MergeClassesMatcher() throws ViatraQueryException {
