      ...
      try {
      	{
      		...
      		new TypeConstraint(body, new FlatTuple(var_a2, var__virtual_1_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://momot.big.tuwien.ac.at/architectureCRA/1.0", "Feature", "isEncapsulatedBy")));
