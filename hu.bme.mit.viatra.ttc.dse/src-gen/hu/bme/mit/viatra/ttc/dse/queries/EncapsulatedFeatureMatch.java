...
/**
 * Pattern-specific match representation of the hu.bme.mit.viatra.ttc.dse.queries.encapsulatedFeature pattern,
 * to be used in conjunction with {@link EncapsulatedFeatureMatcher}.
 * 
...
public abstract class EncapsulatedFeatureMatch extends BasePatternMatch {
  private Feature fF;
  
  private static List<String> parameterNames = makeImmutableList("f");
  
  private EncapsulatedFeatureMatch(final Feature pF) {
    this.fF = pF;
  }
  ...
  public List<String> parameterNames() {
    return EncapsulatedFeatureMatch.parameterNames;
  }
  ...
  @Override
  public EncapsulatedFeatureMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof EncapsulatedFeatureMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    EncapsulatedFeatureMatch other = (EncapsulatedFeatureMatch) obj;
  ...
  @Override
  public EncapsulatedFeatureQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EncapsulatedFeatureMatch newEmptyMatch() {
   ...
   * 
   */
  public static EncapsulatedFeatureMatch newMutableMatch(final Feature pF) {
   ...
   * 
   */
  public static EncapsulatedFeatureMatch newMatch(final Feature pF) {
    return new Immutable(pF);
  }
  
  private static final class Mutable extends EncapsulatedFeatureMatch {
  ...
  private static final class Immutable extends EncapsulatedFeatureMatch {
