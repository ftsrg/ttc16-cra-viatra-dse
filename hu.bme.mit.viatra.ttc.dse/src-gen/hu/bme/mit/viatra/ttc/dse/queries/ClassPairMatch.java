...
/**
 * Pattern-specific match representation of the hu.bme.mit.viatra.ttc.dse.queries.classPair pattern,
 * to be used in conjunction with {@link ClassPairMatcher}.
 * 
...
public abstract class ClassPairMatch extends BasePatternMatch {
  ...
  private ClassPairMatch(final architectureCRA.Class pC1, final architectureCRA.Class pC2) {
    this.fC1 = pC1;
    this.fC2 = pC2;
  }
  ...
  public List<String> parameterNames() {
    return ClassPairMatch.parameterNames;
  }
  ...
  @Override
  public ClassPairMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof ClassPairMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    ClassPairMatch other = (ClassPairMatch) obj;
  ...
  @Override
  public ClassPairQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static ClassPairMatch newEmptyMatch() {
   ...
   * 
   */
  public static ClassPairMatch newMutableMatch(final architectureCRA.Class pC1, final architectureCRA.Class pC2) {
   ...
   * 
   */
  public static ClassPairMatch newMatch(final architectureCRA.Class pC1, final architectureCRA.Class pC2) {
    return new Immutable(pC1, pC2);
  }
  
  private static final class Mutable extends ClassPairMatch {
  ...
  private static final class Immutable extends ClassPairMatch {
