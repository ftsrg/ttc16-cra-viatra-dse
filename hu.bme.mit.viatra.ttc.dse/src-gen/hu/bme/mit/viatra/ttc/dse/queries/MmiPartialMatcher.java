...
public class MmiPartialMatcher extends BaseMatcher<MmiPartialMatch> {
  ...
  public static MmiPartialMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    ...
    if (matcher == null) {
    	matcher = (MmiPartialMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static MmiPartialMatcher create() throws ViatraQueryException {
    return new MmiPartialMatcher();
  }
   ...
   * 
   */
  private MmiPartialMatcher() throws ViatraQueryException {
